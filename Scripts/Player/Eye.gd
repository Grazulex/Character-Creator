...
func set_sprite_keys():
	eye_keys = CharacterManager.player_eyes_collection.keys()
...
func update_sprite():
	...
	if current_sprite == "none":
		...
		eye_sprite.texture = CharacterManager.player_eyes_collection[current_sprite]
		eye_sprite.modulate = CharacterManager.color_options[current_color_index]
	
	CharacterManager.selected_player_eye = current_sprite
	CharacterManager.selected_player_eye_color = CharacterManager.color_options[current_color_index]
