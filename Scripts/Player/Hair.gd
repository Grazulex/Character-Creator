...
func set_sprite_keys():
	hair_keys = CharacterManager.player_hairs_collection.keys()
...
func update_sprite():
	...
	if current_sprite == "none":
		...
		hair_sprite.texture = CharacterManager.player_hairs_collection[current_sprite]
		hair_sprite.modulate = CharacterManager.hairs_color_options[current_color_index]
	
	CharacterManager.selected_player_hair = current_sprite
	CharacterManager.selected_player_hair_color = CharacterManager.hairs_color_options[current_color_index]
