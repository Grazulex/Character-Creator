...
func set_sprite_keys():
	clothe_keys = CharacterManager.portrait_clothes_collection.keys()
...
func update_sprite():
	...
	if current_sprite == "none":
		...
		clothe_sprite.texture = CharacterManager.portrait_clothes_collection[current_sprite]
		clothe_sprite.modulate = CharacterManager.color_options[current_color_index]
	
	CharacterManager.selected_portrait_clothe = current_sprite
	CharacterManager.selected_portrait_clothe_color = CharacterManager.color_options[current_color_index]
