...
func set_sprite_keys():
	skin_keys = CharacterManager.portrait_skins_collection.keys()
	
func update_sprite():
	var current_sprite = skin_keys[current_skin_index]
	skin_sprite.texture = CharacterManager.portrait_skins_collection[current_sprite]
	skin_sprite.modulate = CharacterManager.skins_color_options[current_color_index]
	
	CharacterManager.selected_portrait_skin = current_sprite
	CharacterManager.selected_portrait_skin_color = CharacterManager.skins_color_options[current_color_index]
